...
class Rossmann (object):
    def __init__( self):
        self.home_path='/Users/anaotavio/Documents/repos/ds_prod/rossmann/rossmann_sales/'
    ...
    def data_preparation (self, df5):
        ...
        cols_selected = ['store', 'promo', 'store_type', 'assortment', 'competition_distance', 'competition_open_since_month', 'competition_open_since_year',
            ...
            'day_of_week_sin', 'day_of_week_cos', 'day_sin', 'day_cos', 'week_of_year_cos', 'week_of_year_sin']
    ...
    def get_prediction( self, model, original_data, test_data):
        ...
        returnoriginal_data.to_json( orient = 'recors', data_format='iso')
